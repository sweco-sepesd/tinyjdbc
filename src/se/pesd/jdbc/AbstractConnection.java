...
/**
 * Default implementation of all methods that we don't really care about.
 * 
 * @author Peter Segerstedt
 * 
 *
 */
public abstract class AbstractConnection implements Connection, Database {
	...
	@Override
	public abstract void abort(Executor executor) throws SQLException;
